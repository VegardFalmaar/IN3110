...
from .python_color2gray import convolve

convolve = jit(nopython=True)(convolve)

def numba_color2gray(src, shape):
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        try:
            ...
            numba_color2gray = report(n)(numba_color2gray)
        except ValueError:
    ...
    gray = numba_color2gray(img, shape)
    cv2.imwrite(img_path + 'numba_' + fname.replace('.', '_grayscale.'), gray)
